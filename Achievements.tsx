...
const achievements = [
  {
    ...
    description: "Won first place at National Hackathon Hack2Hire 2023 And 3rd place in HackAzure Hackathon",
    date: "July 2024"
  },
  {
    icon: <Award className="w-8 h-8" />,
    title: "Best Innovation Award",
    description: "Received 2nd Best Innovation Award Google Developers Student Club 2023 for Sustainable development goal solution",
    date: "August 2023"
  },
  /*{
  ...
  },*/
  {
    ...
    description: "Developed Pneumonia detection and oral detection model using AI model",
    date: "Summer 2024"
  }
];
